...
namespace MathDungeonBlazor.Pages.Bases
{
    public class ModeBase : ComponentBase
    {
        ...
        public class Output_String_Mode_1
        {
            public string Variable { get; set; }

            public Output_String_Mode_1(string variable)
            {
                Variable = variable;
            }
        }
        ...
        protected List<Output_String_Mode_1> output_string = new List<Output_String_Mode_1>();
        ...
        public async void Add_Variable_Simple_Mode()
        {
            if (s_m_number != null)
            {
                ...
                {
                    output_partial = output_partial + " , " + s_m_number.ToString();
                    Output_String_Mode_1 obj = new Output_String_Mode_1(output_partial);
        ...
        public async void Delete_Variable_Simple_Mode()
        {
            if(mode_data_list.Count > 0)
            {
                int lenght = mode_data_list.Count;
                mode_data_list.RemoveAt(lenght - 1);
                output_string.RemoveAt(lenght - 1);
                is_Mode = "";
                mode_variables.Clear();
                s_m_result = 0;
                s_m_o_result = 0;
        ...
        public async void Reset_Simple_Mode()
        {
        ...
        public async void Calculate_Simple_Mode()
        {
