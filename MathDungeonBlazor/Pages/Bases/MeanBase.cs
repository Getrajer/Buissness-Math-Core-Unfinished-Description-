...
namespace MathDungeonBlazor.Pages
{
    public class MeanBase : ComponentBase
    {
        ...
        public async void Delete_First_Mean()
        {
        ...
        protected string btn_d_f_text = "Generate Random Data";
        ...
        public async void Delete_C_GDFDO()
        {
        ...
        public async void Delete_GDFDO_ByID(int id)
        {
            if (grouped_Discrete_Frequency_Data_Objects.Count != 0)
            {
                ...
                if (grouped_Discrete_Frequency_Data_Objects.Count == 0)
                {
                    ...
                    GDFR1 = 0;
                    GDFR2 = 0;
                    btn_d_f_text = "Generate Random Data";
                    StateHasChanged();
                }
